## Scenario 1
**Task:** You want to create an empty file named devops.txt in your current directory. Which command will you run?
**Command:**
```bash
touch devops.txt
```
---
## Scenario 2
**Task:** You want to create a directory named logs in your current directory. Which command will you run?
**Command:**
```bash
mkdir logs
```
